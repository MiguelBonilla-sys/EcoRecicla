...
public class CategoryTextil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_textil);
        ...
        registerTextil = findViewById(R.id.button3);
        Double FACTOR = 5850.0;
        registerTextil.setOnClickListener(view -> {
            if (!month.getText().toString().isEmpty() &&
                    !kg.getText().toString().isEmpty() && !price.getText().toString().isEmpty() ) {
                type = "Textil"; // Set type to "Carton" before writing to the file
                File file = new File(getFilesDir(), "Textil.txt");
